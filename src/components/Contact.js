    ...
    <div className="contact">
      <form className="contact__form">
        ...
        <textarea
          ...
          required
        />
        <button type="submit" className="contact__btn" onClick={handleSend}>
          Send
        </button>
      ...
      <div className="contact__informations">
        <h2 className="contact__info">
          <i className="far fa-envelope"> </i> mymotivation@.com
        </h2>
        <h2 className="contact__info">
          <i className="fas fa-phone" /> +48 000 000 000
        </h2>
        <h2 className="contact__info">
          <i className="fab fa-facebook-f" /> /mymotivation
        </h2>
      </div>
    </div>
  );
