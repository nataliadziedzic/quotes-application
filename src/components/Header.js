        ...
        <>
            ...
            <nav className='header__menu header__menu--hidden'>
                <ul className="header__menuList">
                    <li className='header__item'><NavLink to='/' exact >Home</NavLink></li>
                    <li className='header__item'><NavLink to='/start' >Start</NavLink></li>
                    <li className='header__item'><NavLink to='/login' >Login</NavLink></li>
                    <li className='header__item'><NavLink to='/contact' >Contact</NavLink></li>
                </ul>
            </nav>
        </>
    );
